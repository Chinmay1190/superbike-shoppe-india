    ...
    <footer className="bg-background border-t py-12">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-6 gradient-text">SuperBike Shoppe</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Your premium destination for high-performance superbikes in India.
            </p>
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} SuperBike Shoppe. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/products" className="text-muted-foreground hover:text-primary">All Bikes</Link></li>
              <li><Link to="/categories/sport" className="text-muted-foreground hover:text-primary">Sport Bikes</Link></li>
              <li><Link to="/categories/cruiser" className="text-muted-foreground hover:text-primary">Cruiser Bikes</Link></li>
              <li><Link to="/categories/adventure" className="text-muted-foreground hover:text-primary">Adventure Bikes</Link></li>
              <li><Link to="/categories/naked" className="text-muted-foreground hover:text-primary">Naked Bikes</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/account/orders" className="text-muted-foreground hover:text-primary">Order History</Link></li>
              <li><Link to="/cart" className="text-muted-foreground hover:text-primary">Shopping Cart</Link></li>
              <li><Link to="/wishlist" className="text-muted-foreground hover:text-primary">Wishlist</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-muted-foreground">123 Bike Street</li>
              <li className="text-muted-foreground">Mumbai, Maharashtra 400001</li>
              <li className="text-muted-foreground">+91 98765 43210</li>
              <li className="text-muted-foreground">info@superbikeshoppe.in</li>
            </ul>
